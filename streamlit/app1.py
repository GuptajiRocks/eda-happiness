...
def compare_economy_trust():
    ...
    plt.title('GDP and Trust Score by Region')
    plt.xlabel('Country')
    plt.ylabel('Value')
...
def freedom_trust():
    ...
    plt.title('Freedom and Trust Score by Region')
    plt.xlabel('Score')
    plt.ylabel('Region')
    plt.xticks(rotation=45)
    plt.legend()
...
# scatterplot_with_regression(df, x="Economy", y="Health")
# freedom_trust()
# compare_economy_trust()
# eco_vs_geno_me(df)
# ['Southeastern Asia', 'Western Europe', 'Middle East and Northern Africa', 'Central and Eastern Europe', 'Sub-Saharan Africa', 'Latin America and Caribbean', 'North America', 'Australia and New Zealand', 'Southern Asia', 'Eastern Asia']
